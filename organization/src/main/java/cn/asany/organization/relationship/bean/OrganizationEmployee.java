...
public class OrganizationEmployee extends BaseBusEntity {
    ...
    @TableGenerator(name = "org_organization_employee_gen", table = "sys_sequence", pkColumnName = "gen_name", pkColumnValue = "org_organization_employee:id", valueColumnName = "gen_value")
    private Long id;
