...
public class PositionService {
    ...
    public Position save(Long departmentId, Long jobId) {
        Optional<Position> optional = this.positionDao.findOne(Example.of(Position.builder()
                .job(Job.builder().id(jobId).build())
                .department(Department.builder().id(departmentId).build()).build()));
        ...
        builder
                ...
                .job(job).description(job.getDescription())
                .name(job.getName())
                .organization(department.getOrganization()).build();
    ...
    public Position get(Long id) {
        Optional<Position> optional = this.positionDao.findOne(Example.of(Position.builder().id(id).build()));
        return optional.orElse(null);
    }
