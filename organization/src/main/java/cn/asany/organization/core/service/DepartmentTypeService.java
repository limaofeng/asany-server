...
public class DepartmentTypeService {
  ...
  @Autowired private DepartmentTypeDao departmentTypeDao;
  @Autowired private DepartmentDao departmentDao;

  public DepartmentType createDepartmentType(
      String name, String code, Long organization, Boolean multiSectoral, Long andPost) {
  ...
  public boolean removeDepartmentType(Long id) {
    List<Department> all =
        departmentDao.findAll(
            Example.of(Department.builder().type(DepartmentType.builder().id(id).build()).build()));
