...
public interface EmployeeDao extends JpaRepository<Employee, Long> {
    ...
    @Query(nativeQuery = true, value = "SELECT e.id, e.name, h.employee_id as zbsjId, i.organization_id, i.status_id FROM org_employee AS e" +
    ...
    @Query(nativeQuery = true, value ="SELECT e.id, e.name, a.value, h.employee_id as zbsjId, i.organization_id, i.status_id FROM org_employee AS e" +
            " LEFT JOIN org_organization_employee AS c ON e.id = c.employee_id" +
