...
//
//  @RegisterExtension public TestIMAPClient testIMAPClient = new TestIMAPClient();
//
...
//
//      assertThat(testIMAPClient.select("INBOX").readFirstMessage())
//          .contains("\r\n" + SMALL_MESSAGE + ")\r\n");
//    }
//
//    @Test
...
//          MailboxPath.forUser(USER, "pwnd"), mailboxManager.createSystemSession(USER));
//      mailboxManager.createMailbox(
//          MailboxPath.forUser(USER2, "notvuln"), mailboxManager.createSystemSession(USER2));
//
//      testIMAPClient
//          .connect("127.0.0.1", port)
...
//      // Avoids session fixation attacks as described in
...
//              "keystore or (privateKey and certificates) needs to get configured");
//    }
//
//    @Test
...
//          .hasMessage(
//              "class path resource [keystore.notfound.jks] cannot be resolved to URL because it
// does not exist");
//    }
//
//    @Test
...
//      assertThatThrownBy(
//              () -> testIMAPClient.connect("127.0.0.1", port).login(USER.asString(), USER_PASS))
//          .hasMessage("Login failed");
//    }
//
//    @Test
...
//                          + "Message-ID:
// <Mime4j.5f1.9a40f68264d6f2fa.17876fb5605@linagora.com>\r\n"
