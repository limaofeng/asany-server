...
//
//  public SmtpServer(
//      @NonNull SmtpServerProperties properties, Collection<ProtocolHandler> handlers) {
...
//
//    SMTPProtocolHandlerChain chain = new SMTPProtocolHandlerChain(new DefaultMetricFactory());
