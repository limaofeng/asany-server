...
public class RoleService {
    ...
    public void delete(String... ids) {
        ...
        this.roleDao.deleteInBatch(Arrays.asList(ids).stream().map(id -> Role.builder().id(id).build()).collect(Collectors.toList()));
    }
...
//        Example<Role> example = Example.of(Role.builder().scope(scope).organization(Organization.builder().id(org).build()).build());
...
//        List<RoleOfDepartment> departmentIds = roleOfDepartmentDao.findRoleOfDepartmentPkDepartmentIdByPkRoleCode(roleId);
...
//        List<RoleOfEmplyeeGroup> groupIds = roleOfEmplyeeGroupDao.findRoleOfEmplyeeGroupByPkRoleCode(roleId);
...
//                EmployeeGroup employeeGroup = employeeGroupDao.getOne(reg.getPk().getEmployeeGroupId());
...
//        List<RoleOfPosition> positionIds = roleOfPositionDao.findRoleOfPositionPkPositionIdByPkRoleCode(roleId);
