...
//            //检查岗位有没有授权
//            Set<String> positionPermissions = checkPositionPermissions(employee, permisstionArray);
//            permissions.addAll(positionPermissions);
//            //检查员工有没有授权
//            Set<String> employeePermissions = checkEmployeePermissions(employee, permisstionArray);
...
//                int c = grantPermissionDao.countGrantPermissionByPermissionIdAndSecurityTypeAndValue(permission, SecurityType.organization,
...
//        }
    ...
    //判断部门是否有权限
//    private static Set<String> checkDeptPermissions(Employee employee, String[] permisstionArray) {
//        Set<String> hasPermissionsList = new HashSet<>();
//        List<String> deptIds = parseLongToStringList(employee.getDepartmentIds());
//        for (String deptId : deptIds) {
//            for (String permission : permisstionArray) {
//                int c = grantPermissionDao.countGrantPermissionByPermissionIdAndSecurityTypeAndValue(permission, SecurityType.department, deptId);
//                if (c > 0) {
//                    hasPermissionsList.add(permission);
//                }
//            }
...
//            for (String permission : permisstionArray) {
//                int c = grantPermissionDao.countGrantPermissionByPermissionIdAndSecurityTypeAndValue(permission, SecurityType.job, jobId);
//                if (c > 0) {
//                    hasPermissionsList.add(permission);
//                }
//            }
...
//    }
    ...
    //判断岗位是否有权限
//    private static Set<String> checkPositionPermissions(Employee employee, String[] permisstionArray) {
//        Set<String> hasPermissionsList = new HashSet<>();
//        List<String> positionIds = parsePositionsToStringList(employee.getEmployeePositions());
//        for (String positionId : positionIds) {
//            for (String permission : permisstionArray) {
//                int c = grantPermissionDao.countGrantPermissionByPermissionIdAndSecurityTypeAndValue(permission, SecurityType.position, positionId);
//                if (c > 0) {
//                    hasPermissionsList.add(permission);
//                }
//            }
...
//    }
    ...
    //判断员工是否有权限
//    private static Set<String> checkEmployeePermissions(Employee employee, String[] permisstionArray) {
//        Set<String> hasPermissionsList = new HashSet<>();
//        for (String permission : permisstionArray) {
//            int c = grantPermissionDao.countGrantPermissionByPermissionIdAndSecurityTypeAndValue(permission, SecurityType.employee,
...
//    }
    ...
    //判断群组是否有权限
//    private static Set<String> checkGroupPermissions(Employee employee, String[] permisstionArray) {
//        Set<String> hasPermissionsList = new HashSet<>();
//        List<String> groupIds = parseGroupsToStringList(employee.getGroups());
//        for (String groupId : groupIds) {
//            for (String permission : permisstionArray) {
//                int c = grantPermissionDao.countGrantPermissionByPermissionIdAndSecurityTypeAndValue(permission, SecurityType.employeeGroup, groupId);
//                if (c > 0) {
//                    hasPermissionsList.add(permission);
//                }
//            }
...
//    }
    ...
    private static Set<String> checkUserPermissions(User user, String[] permisstionArray) {
        Set<String> hasPermissionsList = new HashSet<>();
        for (String permission : permisstionArray) {
            int c = grantPermissionDao.countGrantPermissionByPermissionIdAndSecurityTypeAndValue(permission, SecurityType.user,
    ...
    private static Set<String> checkRolePermissions(Set<String> userRoles, String[] permisstionArray) {
        Set<String> hasPermissionsList = new HashSet<>();
        for (String roleCode : userRoles) {
            for (String permission : permisstionArray) {
                int c = grantPermissionDao.countGrantPermissionByPermissionIdAndSecurityTypeAndValue(permission, SecurityType.role, roleCode);
                if (c > 0) {
                    hasPermissionsList.add(permission);
                }
            }
...
//    }
    ...
    public static String comparePermissionsResult(Set<String> hasPermissionsList, String[] permisstionArray) {
        //封装成json返回
        ...
        for (String permission : permisstionArray) {
            ...
            sb.append(permission).append(":")
                    .append(hasPermissionsList.contains(permission));
        }
        sb.append("}");
        return sb.toString();
    }
