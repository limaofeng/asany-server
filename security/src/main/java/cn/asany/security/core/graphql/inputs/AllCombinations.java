...
//
//
//    public boolean isRight(SecurityExpressType type, String funName, SecurityExpressType targettype) {
//        if (type == null) {
//            return true;
//        }
//        switch (type) {
...
//            case employeeGroup:
//                List<ScopeTypeResult> employeeGroupCombination = getEmployeeGroupCombination(type);
//                return getScopeRight(employeeGroupCombination, funName, targettype);
//        }
//        return false;
//    }
//
//    public boolean getScopeRight(List<ScopeTypeResult> data, String funName, SecurityExpressType targettype){
//        if (funName == null && targettype == null) {
//            return false;
//        }
//        // 判断函数是否存在
//        List<ScopeTypeResult> collectfun = data.stream().filter(item -> item.getKey().equals(funName)).collect(Collectors.toList());
...
//            collect = targetTypes.stream().filter(item -> item.getKey().equals(targettype)).collect(Collectors.toList());
//
//        }
//        if ((collectfun != null && collectfun .size() >0) && (collect != null && collect .size() >0)){
//            return true;
//        }
//        return false;
//    }
