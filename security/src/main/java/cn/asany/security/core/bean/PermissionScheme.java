...
public class PermissionScheme extends BaseBusEntity {
    ...
    @TableGenerator(name = "auth_permission_scheme_gen", table = "sys_sequence", pkColumnName = "gen_name", pkColumnValue = "auth_permission_scheme:id", valueColumnName = "gen_value")
    private Long id;
    /**
     * 名称
     */
