...
public interface GrantPermissionDao extends JpaRepository<GrantPermission, Long> {
     ...
     */
    void deleteGrantPermissionByPermissionIdAndSecurityType(String permissinId, SecurityType securityType);
     ...
     * @return List
     */
    List<GrantPermission> findGrantPermissionsBySecurityTypeAndValue(SecurityType securityType, String value);
