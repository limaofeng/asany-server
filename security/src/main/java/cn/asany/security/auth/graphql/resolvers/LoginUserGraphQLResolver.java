...
public class LoginUserGraphQLResolver implements GraphQLResolver<LoginUser> {
  ...
  //    public List<Position> positions(LoginUser loginUser, String organizationId, Long
  // departmentId) {
  //        Employee employee = employee(loginUser);
  //        if (employee == null) {
  //            return null;
  //        }
  //        return organizationEmployeeService.findPostions(employee.getId(), organizationId,
  // departmentId);
  //    }
  ...
  //        OrganizationEmployee organizationEmployee = getOrganizationEmployee(loginUser,
  // organization);
   ...
   * @return
   */
  //    public OrganizationEmployee getOrganizationEmployee(LoginUser loginUser, String
  // organization) {
  //        Employee employee = employee(loginUser);
  //        if (employee == null) {
  //            return null;
