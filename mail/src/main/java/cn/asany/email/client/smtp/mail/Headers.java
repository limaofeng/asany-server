...
public final class Headers {
  ...
  public @Nullable Date getDate(String name) {
    ...
    return value != null ? SmtpDate.parse(value) : null;
  }
   ...
   * not equal according to this method. In particular, none of the following sets of headers are
   ...
   * }</pre>
   *
   * <p>Applications that require semantically equal headers should convert them into a canonical
   * form before comparing them for equality.
   */
  @Override
  ...
  public static final class Builder {
    ...
    private void checkNameAndValue(String name, String value) {
      ...
      //        }
      //      }
      //      if (value == null) throw new NullPointerException("value for name " + name + " ==
      // null");
