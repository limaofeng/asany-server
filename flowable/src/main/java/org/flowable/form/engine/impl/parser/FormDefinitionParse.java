 ...
 * <br/>
 * 从 FormEngineConfiguration 中获取 FormJsonConverter 对象，然后调用其 convertToFormModel 方法，将 json 转换为 SimpleFormModel 对象。
 *
...
public class FormDefinitionParse {
  ...
  public FormDefinitionParse execute(FormEngineConfiguration formEngineConfig) {
    ...
    FormJsonConverter converter = formEngineConfig.getFormJsonConverter();
