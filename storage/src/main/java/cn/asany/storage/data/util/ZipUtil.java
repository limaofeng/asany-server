...
public class ZipUtil {
    ...
    public void compress(OutputStream outputStream, FileObject fileObject, String comment) {
        compress(outputStream, fileObject, new FileItemSelector() {
     ...
     * @功能描述
     */
    public void compress(OutputStream outputStream, FileObject fileObject, String encoding, String comment) {
        compress(outputStream, fileObject, new FileItemSelector() {
     ...
     * @功能描述
     */
    public void compress(OutputStream outputStream, FileObject fileObject, FileItemSelector selector, String encoding, String comment) {
        ZipOutputStream out = new ZipOutputStream(outputStream);
        List<FileObject> fileObjects = fileObject.listFiles(selector);
        for (FileObject item : fileObjects) {
            ZipEntry entry = new ZipEntry(item.getAbsolutePath().replaceFirst(fileObject.getAbsolutePath(), ""));
            try {
